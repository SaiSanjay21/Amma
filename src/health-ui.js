...
export function showHealthOnboarding() {
    ...
    const steps = [
        ...
        <h2>Welcome!</h2>
        <p>I'm <span class="gradient-text">Amma</span>. Let me learn a bit about you to give better health reminders.</p>
        <button class="btn btn-primary btn-lg" id="onboard-next" style="width:100%; margin-top: 20px;">Get Started</button>
      `,
            save: () => { },
        },
        {
        ...
        <div class="form-group"><input type="number" id="onboard-age" min="1" max="120" placeholder="e.g. 25" /></div>
        <button class="btn btn-primary" id="onboard-next" style="width:100%;">Next</button>
      `,
        ...
        <div class="form-group"><input type="number" id="onboard-height" placeholder="e.g. 170" /></div>
        <button class="btn btn-primary" id="onboard-next" style="width:100%;">Next</button>
      `,
        ...
        {
            html: `
        <h3>What's your weight? (kg)</h3>
        <div class="form-group"><input type="number" id="onboard-weight" step="0.1" placeholder="e.g. 70" /></div>
        <button class="btn btn-primary" id="onboard-next" style="width:100%;">Next</button>
      `,
        ...
        <div class="quick-log-row" style="justify-content: center;">
          <button class="btn btn-secondary chip-btn" data-gender="MALE">Male</button>
          <button class="btn btn-secondary chip-btn" data-gender="FEMALE">Female</button>
          <button class="btn btn-secondary chip-btn" data-gender="OTHER">Other</button>
        </div>
      `,
            save: () => { },
            isChip: true,
        ...
        {
            html: `
        <h3>How active are you daily?</h3>
        <div class="quick-log-row" style="flex-direction: column; gap: 8px;">
          <button class="btn btn-secondary chip-btn" data-activity="SEDENTARY">🪑 Mostly sitting</button>
          <button class="btn btn-secondary chip-btn" data-activity="LIGHT">🚶 Light activity</button>
          <button class="btn btn-secondary chip-btn" data-activity="MODERATE">🏃 Moderately active</button>
          <button class="btn btn-secondary chip-btn" data-activity="ACTIVE">💪 Very active</button>
        </div>
      `,
            save: () => { },
            isChip: true,
        ...
        {
            html: `
        <h3>What time do you usually wake up?</h3>
        <div class="form-group"><input type="time" id="onboard-wake" value="07:00" /></div>
        <button class="btn btn-primary" id="onboard-next" style="width:100%;">Next</button>
      `,
            save: () => {
        ...
        {
            html: `
        <h3>What time do you usually sleep?</h3>
        <div class="form-group"><input type="time" id="onboard-sleep" value="23:00" /></div>
        <button class="btn btn-primary" id="onboard-next" style="width:100%;">Next</button>
      `,
            save: () => {
        ...
        {
            html: `
        <h3>Average daily sunlight?</h3>
        <div class="form-group">
          <label>Minutes in sunlight per day: <span id="onboard-sun-val">30</span></label>
      ...
      `,
        ...
        // Step 10: Summary (generated dynamically in renderStep)
        {
    ...
    function renderStep() {
        ...
        <div class="empty-icon" style="font-size: 3rem;">🎉</div>
        <h2>All Set!</h2>
        <p>Here are your daily targets:</p>
        <div class="card" style="text-align: left; margin: 16px 0;">
          <div class="health-summary-row"><span>💧 Water</span><span>${wt} ml</span></div>
          <div class="health-summary-row"><span>🔥 Calories</span><span>${cal} kcal</span></div>
        </div>
        <p style="font-size: 0.8rem; opacity: 0.6;">Based on your profile. ⓘ Not medical advice.</p>
        <button class="btn btn-primary btn-lg" id="onboard-finish" style="width:100%; margin-top: 16px;">Start Using Amma ❤️</button>
      `;
        }
      ...
      <div class="card onboarding-card">
        ${html}
        ${currentStep > 0 && !step.isSummary ? '<p style="margin-top: 12px;"><a href="#" id="onboard-skip" style="color: var(--text); opacity: 0.5; font-size: 0.8rem;">Skip for now</a></p>' : ''}
      </div>
    `;
